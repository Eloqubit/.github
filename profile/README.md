...
We design and build software systems with an emphasis on:
...
- Feature factories
- Overpromising speed at the cost of quality
...
Some principles that guide our work:

- Software is a long-lived system
...
- Select client-safe examples

Not every repository is production-ready or actively maintained.
Each exists to explore, validate, or document an idea.
...
Specific choices vary by project.
